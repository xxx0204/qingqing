 ...
 *初始化增加部分字体颜色设置
 */
-(id)initWithTitle:(NSString *)title message:(NSString *)message andRange:(NSRange)range andColor:(UIColor *)color buttonTitles:(NSString *)otherButtonTitles,... NS_REQUIRES_NIL_TERMINATION;
/**
 *  显示弹出框
 */
