...
- (void)configUI
{
    ...
    self.frameView.frame = self.reshapeScaleF;
    self.frameView.center = CGPointMake(self.view.center.x, self.view.center.y-25);
...
- (UIImageView *)frameView
{
    if(!_frameView){
        ...
        _frameView.layer.borderColor=DZColorFromRGB(0xFF93A0).CGColor;
